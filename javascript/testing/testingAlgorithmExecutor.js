...
console.log('Test GAV AlgorithmExecutor component 1:', testResults.message1);
console.log('Test GAV AlgorithmExecutor component 2:', testResults.message2);

// Store the result back into the global space called GAVAlgorithmExecutorResults
window.GAVAlgorithmExecutorResults = {
